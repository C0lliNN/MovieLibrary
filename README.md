...
A very easy to use Web Application developed in [ReactJS](https://reactjs.org/){:target="_blank"} that uses the [Movie Database API](https://www.themoviedb.org/){:target="_blank"} allowing users search by movies' information in friendly way. 
